 ...
 * TextEncoder objects.  See set_encoding().
 */ 0 
44 0 0 4 73 607 0 0 0 2 4 this 3 621  4 text 1 587  
45 0 0 4 73 607 0 0 0 3 4 this 3 621  4 text 1 587  8 encoding 1 586  
 ...
 * (preserving accent marks correctly).
 */ 1 4 this 3 621  
50 0 0 6 78 587 0 0 80 /**
 * Returns the current text, as encoded via the current encoding system.
 */ 1 4 this 3 622  
51 0 0 6 78 587 0 0 82 /**
 * Returns the current text, as encoded via the indicated encoding system.
 */ 2 4 this 3 622  8 encoding 1 586  
52 0 0 4 79 607 0 0 0 2 4 this 3 621  4 text 1 587  
 ...
 * should be called in preference to get_text()).
 */ 1 4 this 3 622  
78 0 0 6 102 587 0 0 136 /**
 * Encodes a single Unicode character into a one-, two-, three-, or four-byte
 * string, according to the given encoding system.
 */ 2 2 ch 1 624  8 encoding 1 586  
79 0 0 6 103 587 0 0 102 /**
 * Encodes a wide-text string into a single-char string, according to the
 * current encoding.
 */ 2 4 this 3 622  5 wtext 1 618  
80 0 0 6 103 587 0 0 100 /**
 * Encodes a wide-text string into a single-char string, according to the
 * given encoding.
 */ 2 5 wtext 1 618  8 encoding 1 586  
81 0 0 6 104 587 0 0 0 2 4 this 3 622  4 text 1 587  
82 0 0 6 104 587 0 0 0 2 4 text 1 587  8 encoding 1 586  
83 0 0 7 111 627 477 0 37 /**
 * Creates an empty Filename.
 */ 0 
84 0 0 7 111 627 477 0 146 /**
 * This constructor composes the filename out of a directory part and a
 * basename part.  It will insert an intervening '/' if necessary.
 */ 2 7 dirname 1 628  8 basename 1 628  
85 0 0 7 111 627 477 0 0 1 4 path 1 587  
86 0 0 6 112 587 0 0 0 1 4 this 3 628  
...
110 0 0 6 132 587 0 0 0 1 4 this 3 628  
111 0 0 6 133 587 0 0 0 1 4 this 3 628  
...
117 0 0 7 138 627 477 0 0 2 4 this 3 628  5 other 1 628  
...
169 0 0 6 189 587 0 0 0 1 4 this 3 628  
...
226 0 0 7 269 645 514 0 0 1 4 copy 1 635  
227 0 0 7 269 645 514 0 10 /**
 *
 */ 1 9 directory 1 628  
228 0 0 7 269 645 514 0 10 /**
 *
...
255 0 0 7 307 651 543 0 0 1 6 param0 0 649  
 ...
 * Returns the name of the current working directory.
 */ 0 
269 0 0 7 310 654 561 0 10 /**
 *
 */ 1 4 copy 1 652  
270 0 0 7 310 654 561 0 10 /**
 *
 */ 1 7 pattern 5 618  
 ...
 * through sorted indices.
 */ 1 4 this 3 652  
286 0 0 6 330 587 0 0 0 2 4 this 3 652  3 cwd 5 628  
