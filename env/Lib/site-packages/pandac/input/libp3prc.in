...
382
384 11 ConfigFlags 0 260 766 24 ConfigFlags::ConfigFlags 0 2 1 2 0
112
inline ConfigFlags::ConfigFlags(void) = default;
inline ConfigFlags::ConfigFlags(ConfigFlags const &) = default;

385 12 ~ConfigFlags 0 516 766 25 ConfigFlags::~ConfigFlags 0 0 0
32
...
463 6 Notify 0 260 783 14 Notify::Notify 0 2 81 82 10
/**
 *
 */
70
...
464 7 ~Notify 0 516 783 15 Notify::~Notify 0 0 10
/**
 *
 */
22
...
524 14 ConfigVariable 0 260 788 30 ConfigVariable::ConfigVariable 0 2 143 144 458
/**
...
525 15 ~ConfigVariable 0 516 788 31 ConfigVariable::~ConfigVariable 0 0 10
/**
 *
 */
45
...
530 18 ConfigVariableBool 0 260 789 38 ConfigVariableBool::ConfigVariableBool 0 4 149 150 151 152 34
/**
 *
 */
...
540 19 ~ConfigVariableBool 0 516 789 39 ConfigVariableBool::~ConfigVariableBool 0 0 0
46
ConfigVariableBool::~ConfigVariableBool(void);

541 20 ConfigVariableDouble 0 260 790 42 ConfigVariableDouble::ConfigVariableDouble 0 4 162 163 164 165 34
/**
 *
 */
...
551 21 ~ConfigVariableDouble 0 516 790 43 ConfigVariableDouble::~ConfigVariableDouble 0 0 0
50
ConfigVariableDouble::~ConfigVariableDouble(void);

552 22 ConfigVariableFilename 0 260 792 46 ConfigVariableFilename::ConfigVariableFilename 0 3 175 176 177 22
/**
 *
 */
...
573 23 ~ConfigVariableFilename 0 516 792 47 ConfigVariableFilename::~ConfigVariableFilename 0 0 0
54
ConfigVariableFilename::~ConfigVariableFilename(void);

574 17 ConfigVariableInt 0 260 794 36 ConfigVariableInt::ConfigVariableInt 0 4 198 199 200 201 34
/**
 *
 */
...
584 18 ~ConfigVariableInt 0 516 794 37 ConfigVariableInt::~ConfigVariableInt 0 0 0
44
ConfigVariableInt::~ConfigVariableInt(void);

585 19 ConfigVariableInt64 0 260 795 40 ConfigVariableInt64::ConfigVariableInt64 0 4 211 212 213 214 34
/**
 *
 */
...
595 20 ~ConfigVariableInt64 0 516 795 41 ConfigVariableInt64::~ConfigVariableInt64 0 0 0
48
ConfigVariableInt64::~ConfigVariableInt64(void);

596 18 ConfigVariableList 0 260 798 38 ConfigVariableList::ConfigVariableList 0 2 224 225 10
/**
 *
 */
214
...
597 19 ~ConfigVariableList 0 516 798 39 ConfigVariableList::~ConfigVariableList 0 0 10
/**
 *
 */
53
...
606 24 ConfigVariableSearchPath 0 260 799 50 ConfigVariableSearchPath::ConfigVariableSearchPath 0 3 234 235 236 34
/**
 *
 */
...
607 25 ~ConfigVariableSearchPath 0 516 799 51 ConfigVariableSearchPath::~ConfigVariableSearchPath 0 0 10
/**
 *
 */
65
...
624 20 ConfigVariableString 0 260 801 42 ConfigVariableString::ConfigVariableString 0 3 255 256 257 22
/**
 *
 */
...
639 21 ~ConfigVariableString 0 516 801 43 ConfigVariableString::~ConfigVariableString 0 0 0
50
...
665 14 NotifyCategory 0 260 802 30 NotifyCategory::NotifyCategory 0 1 272 10
/**
 *
 */
72
...
666 15 ~NotifyCategory 0 516 802 31 NotifyCategory::~NotifyCategory 0 0 0
38
NotifyCategory::~NotifyCategory(void);

667 14 IDecryptStream 0 260 805 30 IDecryptStream::IDecryptStream 0 2 296 297 22
/**
 *
 */
...
673 15 ~IDecryptStream 0 516 805 31 IDecryptStream::~IDecryptStream 0 0 0
38
IDecryptStream::~IDecryptStream(void);

674 14 OEncryptStream 0 260 807 30 OEncryptStream::OEncryptStream 0 2 303 304 22
/**
 *
 */
...
683 15 ~OEncryptStream 0 516 807 31 OEncryptStream::~OEncryptStream 0 0 0
38
OEncryptStream::~OEncryptStream(void);

684 12 StreamReader 0 260 809 26 StreamReader::StreamReader 0 2 310 311 189
/**
 *
 */
...
686 13 ~StreamReader 0 516 809 27 StreamReader::~StreamReader 0 0 10
/**
 *
 */
41
...
715 12 StreamWriter 0 260 811 26 StreamWriter::StreamWriter 0 2 341 342 94
/**
 *
 */
...
717 13 ~StreamWriter 0 516 811 27 StreamWriter::~StreamWriter 0 0 10
/**
 *
 */
41
...
750 18 ~StreamWrapperBase 0 516 813 37 StreamWrapperBase::~StreamWrapperBase 0 0 0
44
...
752 14 IStreamWrapper 0 260 814 30 IStreamWrapper::IStreamWrapper 0 1 374 22
/**
 *
 */
...
753 15 ~IStreamWrapper 0 516 814 31 IStreamWrapper::~IStreamWrapper 0 0 10
/**
 *
 */
38
...
756 14 OStreamWrapper 0 260 815 30 OStreamWrapper::OStreamWrapper 0 1 377 22
/**
 *
 */
...
757 15 ~OStreamWrapper 0 516 815 31 OStreamWrapper::~OStreamWrapper 0 0 10
/**
 *
 */
38
...
763 13 StreamWrapper 0 260 816 28 StreamWrapper::StreamWrapper 0 1 380 22
/**
 *
 */
...
764 14 ~StreamWrapper 0 516 816 29 StreamWrapper::~StreamWrapper 0 0 10
/**
 *
 */
36
 ...
 * This method basically pre-defines all variables that match the specified
 * glob pattern.
 */ 6 4 this 3 838  7 pattern 1 824  4 type 1 767  13 default_value 1 824  11 description 5 824  5 flags 5 774  
 ...
 *
 */ 4 4 name 1 824  13 default_value 1 773  11 description 5 824  5 flags 5 774  
152 0 0 7 211 849 540 0 10 /**
 *
 */ 4 4 name 1 824  13 default_value 1 824  11 description 5 824  5 flags 5 774  
 ...
 *
 */ 4 4 name 1 824  13 default_value 1 791  11 description 5 824  5 flags 5 774  
 ...
 *
 */ 4 4 name 1 824  13 default_value 1 856  11 description 5 824  5 flags 5 774  
 ...
 *
 */ 4 4 name 1 824  13 default_value 1 774  11 description 5 824  5 flags 5 774  
 ...
 *
 */ 4 4 name 1 824  13 default_value 1 796  11 description 5 824  5 flags 5 774  
 ...
 *
 */ 3 4 name 1 824  11 description 5 824  5 flags 5 774  
 ...
 *
 */ 4 4 name 1 824  13 default_value 1 868  11 description 1 824  5 flags 5 774  
235 0 0 7 307 869 607 0 10 /**
 *
 */ 3 4 name 1 824  11 description 5 824  5 flags 5 774  
236 0 0 7 307 869 607 0 10 /**
 *
 */ 4 4 name 1 824  13 default_value 1 824  11 description 1 824  5 flags 5 774  
 ...
 * Adds all of the directories listed in the search path to the end of the
 * search list.
 */ 3 4 this 3 869  4 path 1 824  9 separator 5 824  
 ...
 * the Notify::out() stream and returns that.  If the severity level is
 * disabled, this returns Notify::null().
 */ 3 4 this 3 877  8 severity 1 782  6 prefix 5 773  
285 0 0 6 370 812 0 0 49 /**
 * A shorthand way to write out(NS_spam).
 */ 2 4 this 3 877  6 prefix 5 773  
